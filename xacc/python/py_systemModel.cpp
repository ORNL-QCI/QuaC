...
PYBIND11_MODULE(_pyquaC, m) 
{
	...
	.def("HanningPulse", [](std::vector<double> alpha_vector, size_t in_nbSamples, size_t in_K, double in_T, double in_dt) {
        return QuaC::HanningPulse(alpha_vector, in_nbSamples, in_K, in_T, in_dt);
    })
