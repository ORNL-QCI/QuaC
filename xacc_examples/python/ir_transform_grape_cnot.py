...
# This example demonstrates the IR transformation utility of XACC 
# using the GRAPE pulse optimization method to optimize
# times-series pulses to achieve a target unitary representing
# arbitrary quantum circuit (in this case a CNOT gate)
# Adapt from:
